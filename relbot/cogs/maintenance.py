...
from relbot.config import BACKUP_INTERVAL_HOURS, HEAT_DECAY_PER_HOUR, HEARTBEAT_PATH
from relbot.db import backup_db, decay_heat, prune_actions
...
class Maintenance(commands.Cog):
    ...
    @tasks.loop(hours=1)
    async def heat_decay(self):
        await decay_heat(HEAT_DECAY_PER_HOUR)
